...
from model.extra_ops.group_norm import GroupNorm2d
...
TSN Configurations:
    ...
    def _prepare_base_model(self, base_model):
        if 'vgg' in base_model:
        ...
        elif 'resnet50' in base_model or 'resnet101' in base_model or 'resnet152' in base_model:
            ...
            import backbone
            self.base_model = getattr(backbone, base_model)(pretrained='imagenet+background')
            self.base_model.last_layer_name = 'last_linear'
            self.input_size = 331
            self.input_mean = [0.5]
            self.input_std = [0.5]
