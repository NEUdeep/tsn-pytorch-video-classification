...
__C.DATA.input_type = 'video'  # the type of input, etc. choices=['Image','Frames','Video']
...
__C.MODEL.consensus_type = 'avg' # the type of consenus segment, etc. choices=['avg', 'max', 'topk', 'identity', 'rnn', 'cnn']
...
__C.OPT.clip_gradient = 20 # gradient norm clipping (default: disabled)
...
#__C.RUN.gpus = [0,1,2,3] # mutil gpu 
__C.RUN.gpus = None
__C.RUN.flow_prefix = ""
__C.RUN.workers = 8  # number of data loading workers
__C.RUN.evaluate = 'False' # evaluate model on validation set
#
# logger options
#
__C.LOG = edict()
